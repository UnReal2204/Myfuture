...
const handleClick =()=>{
  ...
  return(
    ...
    {question?.answers.map((a)=>(
        <div className="answer" onClick={handleClick}>{a.text}</div>
    ))}
...
timer1();
      ...
      $('.answers .answer').click(function(){
          var correctIndex=Questions[num][5];
          var correctAns= Questions[num][correctIndex];
        ...
        //  console.log(a.value);
          ...
          //  document.querySelector('.answer').classList.add("correct");
            ...
            $(this).addClass('incorrect');
              clearInterval(interval);
          // timer1();
              //document.querySelector('.answer').classList.add("incorrect");
          }
      });
...
function fiftyfifty(){
//   randIncorrect= Math.floor(Math.random() * 4);
//     var incorrectIndex=Questions[num][1][2][3][4];
//   var removeAns = Questions[num][incorrectIndex];
//   Questions.splice($.inArray(removeAns, Questions),2);
// }
//
//
// function swap(){
//   const temp = Questions[num];
//   Questions[num] =
//
//
}
...
//     var incorrectIndex=Questions[num][1][2][3][4];
//   var removeAns = Questions[num][incorrectIndex];
//   Questions.splice($.Questions(removeAns, Questions),2);
// }
//
//
// function swap(){
